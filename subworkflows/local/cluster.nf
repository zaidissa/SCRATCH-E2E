...
workflow CLUSTER {
    ...
    main:
        ...
        SEURAT_NORMALIZE(ch_seurat_object, ch_notebook_normalize, ch_page_config)
        SEURAT_CLUSTER(SEURAT_NORMALIZE.out.seurat_rds, ch_notebook_clustering, ch_page_config)

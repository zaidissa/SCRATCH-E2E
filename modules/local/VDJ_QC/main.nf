process VDJ_QC {
    ...
    stub:
        """
        mkdir -p VDJ_QC/figures VDJ_QC/tables
        touch VDJ_QC/figures/stub_output
        echo "stub" > VDJ_QC/tables/contigs_after_qc.tsv
        touch VDJ_QC/tables/stub_output
        echo "<html><body>stub</body></html>" > VDJ_QC_analysis.html
        """
}
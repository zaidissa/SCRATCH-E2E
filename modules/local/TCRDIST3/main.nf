process TCRDIST3 {
    ...
    stub:
        """
        mkdir -p TCRdist3_Report/data TCRdist3_Report/figures TCRdist3_Report/tables
        echo "<html><body>stub</body></html>" > TCRdist3_Report.html
        touch TCRdist3_Report/data/seurat_with_TCRdist3.rds
        touch TCRdist3_Report/figures/stub_output
        touch TCRdist3_Report/tables/stub_output
        echo "stub" > TCRdist3_Report/tables/tcrdist3_export_cells.tsv
        """
}

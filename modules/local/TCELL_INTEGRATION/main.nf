process TCELL_INTEGRATION {
    ...
    stub:
        """
        mkdir -p TCell_Integration_Report/data TCell_Integration_Report/figures TCell_Integration_Report/tables
        echo "<html><body>stub</body></html>" > TCell_Integration_Report.html
        touch TCell_Integration_Report/data/seurat_tcells_with_TCR.rds
        touch TCell_Integration_Report/figures/stub_output
        touch TCell_Integration_Report/tables/stub_output
        echo "stub" > TCell_Integration_Report/tables/tcr_export_cells_with_embedding.tsv
        """
}
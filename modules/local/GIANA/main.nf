process GIANA {
    ...
    stub:
        """
        mkdir -p GIANA_Report/data GIANA_Report/figures GIANA_Report/tables
        echo "<html><body>stub</body></html>" > GIANA_Report.html
        touch GIANA_Report/data/seurat_with_GIANA.rds
        touch GIANA_Report/figures/stub_output
        echo "stub" > GIANA_Report/tables/giana_export_cells.tsv
        touch GIANA_Report/tables/stub_output
        """
}

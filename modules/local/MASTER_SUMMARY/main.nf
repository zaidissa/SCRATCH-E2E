process MASTER_SUMMARY {
    ...
    stub:
        """
        mkdir -p Master_Summary_Report/figures Master_Summary_Report/tables
        echo "<html><body>stub</body></html>" > Master_Summary_Report.html
        touch Master_Summary_Report/figures/stub_output
        touch Master_Summary_Report/tables/stub_output
        """
}
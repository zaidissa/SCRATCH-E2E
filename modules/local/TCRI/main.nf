process TCRI {
    ...
    stub:
        """
        mkdir -p TCRi_Report/data TCRi_Report/figures TCRi_Report/tables
        echo "<html><body>stub</body></html>" > TCRi_Report.html
        touch TCRi_Report/data/seurat_with_TCRi.rds
        touch TCRi_Report/data/stub_output
        touch TCRi_Report/figures/stub_output
        touch TCRi_Report/tables/stub_output
        echo "stub" > TCRi_Report/tables/tcri_export_cells.tsv
        """
}

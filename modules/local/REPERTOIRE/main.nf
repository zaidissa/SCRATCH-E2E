process REPERTOIRE {
    ...
    stub:
        """
        mkdir -p Repertoire_Report/figures Repertoire_Report/tables
        echo "<html><body>stub</body></html>" > Repertoire_Report.html
        touch Repertoire_Report/figures/stub_output
        touch Repertoire_Report/tables/stub_output
        """
}